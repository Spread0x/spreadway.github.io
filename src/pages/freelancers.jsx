...
*/}
      ...
      <section id="cases" class="loyal-orange-bleached">
        <div className="container">
          <div className="row">
            ...
            <div className="col-mdd-12">
              <div className="cases-box fadeInLeft animate">
                <img
                  src="/images/step1freelancer.svg"
              ...
              <div className="cases-box fadeInLeft animate">
                <img
                  src="/images/step2freelancer.svg"
                  className="spread-main"
                  alt="exchanges"
                />
                <div className="case-desc">
                  <h4>
                    We evaluate your commits and validate your level of
                    experience
                  </h4>
                  <h6 className="cases-text2">
                    Use our history intraday market data for backtesting your
              ...
              <div className="cases-box fadeInLeft animate">
                <img
                  src="/images/step3freelancer.svg"
                  className="spread-main"
                  alt="exchanges"
                />
                <div className="case-desc">
                  <h4>
                    Wait for our system to match you with relevant projects
                  </h4>
                  <h6 className="cases-text2">
                    Use our history intraday market data for backtesting your
                    models, and our real-time market data stream for live
              ...
              <div className="cases-box fadeInLeft animate">
                <img
                  src="/images/step4freelancer.svg"
                  className="spread-main"
                  alt="exchanges"
                />
                <div className="case-desc">
      ...
      <section id="benefits" class="loyal-orange">
        <div className="container">

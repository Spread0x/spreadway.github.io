        ...
        <div className="container">
          ...
          <div className="collapse navbar-collapse" id="navbar-collapse" aria-expanded="false">
            ...
            <ul className="nav navbar-nav navbar-right">
              ...
              <li><a href="https://docs.coinapi.io/" target="_blank">API Docs</a></li>
              <li className><a href="/pricing">Pricing</a></li>
              <li className><a target="_blank" href="/faq">FAQ</a></li>
          ...
          <div className="row">
            <div className="col-md-6">
              <h2 className="fadeInLeft animate">
                all cryptocurrency<br />
                exchanges integrated<br />
                under a single API
              </h2>
              <h4 className="fadeInLeft animate">
                CoinAPI is a platform which provides fast, reliable<br />
                and unified data APIs to cryptocurrency markets.
              </h4>
              <a className="btn btn-api fadeInUp animate" href="/pricing?apikey">Get a free API key</a>
            ...
            <div className="col-md-6 coinapi-images">
              <img src="https://www.coinapi.io/images/x2/coinapi.png" className="coinapi-main" alt="exchanges" />
              <div className="coinapi-exchanges hidden-xs">
                <img src="https://www.coinapi.io/images/x2/gdax.png" className="show-hide gdax" alt="gdax" />
                <img src="https://www.coinapi.io/images/x2/poloniex.png" className="show-hide poloniex" alt="poloniex" />
                <img src="https://www.coinapi.io/images/x2/huobi.png" className="show-hide huobi" alt="huobi" />
                <img src="https://www.coinapi.io/images/x2/okcoin.png" className="show-hide okcoin" alt="okcoin" />
                <img src="https://www.coinapi.io/images/x2/kraken.png" className="show-hide kraken" alt="kraken" />
                <img src="https://www.coinapi.io/images/x2/bitstamp.png" className="show-hide bitstamp" alt="bitstamp" />
              </div>
              <div className="coinapi-exchanges visible-xs">
                <img src="https://www.coinapi.io/images/x2/gdax-rwd.png" className="show-hide gdax" alt="gdax" />
                <img src="https://www.coinapi.io/images/x2/poloniex-rwd.png" className="show-hide poloniex" alt="poloniex" />
                <img src="https://www.coinapi.io/images/x2/huobi-rwd.png" className="show-hide huobi" alt="huobi" />
                <img src="https://www.coinapi.io/images/x2/okcoin-rwd.png" className="show-hide okcoin" alt="okcoin" />
                <img src="https://www.coinapi.io/images/x2/kraken-rwd.png" className="show-hide kraken" alt="kraken" />
                <img src="https://www.coinapi.io/images/x2/bitstamp-rwd.png" className="show-hide bitstamp" alt="bitstamp" />
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="container">
          <div className="row">
            ...
            <div className="col-sm-6 content-box order-1">
              ...
              <p className="fadeInRight animate">All CoinAPI data is standardized. Market symbol details and asset codes are double-checked by real humans to ensure <strong>maximum quality</strong>.</p>
            </div>
          </div>
        </div>
      </section>
        ...
        <div className="container">
          <div className="row">
            ...
            <div className="col-md-7 data-images">
              <img src="https://www.coinapi.io/images/data-delivery.gif" className="data-main" alt="data" />
            </div>
          </div>
        </div>
      </section>
        ...
        <div className="container">
          ...
          <div className="logo-carousel">
            <div id="myCarousel" className="carousel slide">
              <div className="carousel-inner">
                  ...
                  <div className="logo">
                    <div className="logo-box">
                      <div className="logo-img">
                        <img className="img-color" src="https://www.coinapi.io/images/python-color.png" />
                        <img className="img-grey" src="https://www.coinapi.io/images/python-grey.png" />
                      </div>
                      <p>python</p>
                    </div>
                  </div>
                ...
                <div className="item">
                  <div className="logo">
                    <div className="logo-box">
                      <div className="logo-img">
                        <img className="img-color" src="https://www.coinapi.io/images/r-color.png" />
                        <img className="img-grey" src="https://www.coinapi.io/images/r-grey.png" />
                      </div>
                      <p>r</p>
                    </div>
                  </div>
                ...
                <div className="item">
                  <div className="logo">
                    <div className="logo-box">
                      <div className="logo-img">
                        <img className="img-color" src="https://www.coinapi.io/images/matlab-color.png" />
                        <img className="img-grey" src="https://www.coinapi.io/images/matlab-grey.png" />
                      </div>
                      <p>matlab</p>
                    </div>
                  </div>
                ...
                <div className="item">
                  <div className="logo">
                    <div className="logo-box">
                      <div className="logo-img">
                        <img className="img-color" src="https://www.coinapi.io/images/c-color.png" />
                        <img className="img-grey" src="https://www.coinapi.io/images/c-grey.png" />
                      </div>
                      <p>c++</p>
                    </div>
                  </div>
                ...
                <div className="item">
                  <div className="logo">
                    <div className="logo-box">
                      <div className="logo-img">
                        <img className="img-color" src="https://www.coinapi.io/images/net-color.png" />
                        <img className="img-grey" src="https://www.coinapi.io/images/net-grey.png" />
                      </div>
                      <p>.net</p>
                    </div>
                  </div>
                ...
                <div className="item">
                  <div className="logo">
                    <div className="logo-box">
                      <div className="logo-img">
                        <img className="img-color" src="https://www.coinapi.io/images/java-color.png" />
                        <img className="img-grey" src="https://www.coinapi.io/images/java-grey.png" />
                      </div>
                      <p>java</p>
                    </div>
                  </div>
                ...
                <div className="item">
                  <div className="logo">
                    <div className="logo-box">
                      <div className="logo-img">
                        <img className="img-color" src="https://www.coinapi.io/images/js-color.png" />
                        <img className="img-grey" src="https://www.coinapi.io/images/js-grey.png" />
                      </div>
                      <p>javascript</p>
                    </div>
                  </div>
                ...
                <div className="item">
                  <div className="logo">
                    <div className="logo-box">
                      <div className="logo-img">
                        <img className="img-color" src="https://www.coinapi.io/images/typescript-color.png" />
                        <img className="img-grey" src="https://www.coinapi.io/images/typescript-grey.png" />
                      </div>
                      <p>typescript</p>
                    </div>
                  </div>
                ...
                <div className="item">
                  <div className="logo">
                    <div className="logo-box">
                      <div className="logo-img">
                        <img className="img-color" src="https://www.coinapi.io/images/node-color.png" />
                        <img className="img-grey" src="https://www.coinapi.io/images/node-grey.png" />
                      </div>
                      <p>node.js</p>
                    </div>
                  </div>
                ...
                <div className="item">
                  <div className="logo">
                    <div className="logo-box">
                      <div className="logo-img">
                        <img className="img-color" src="https://www.coinapi.io/images/gopher-color.png" />
                        <img className="img-grey" src="https://www.coinapi.io/images/gopher-grey.png" />
                      </div>
                      <p>go</p>
                    </div>
                  </div>
                ...
                <div className="item">
                  <div className="logo">
                    <div className="logo-box">
                      <div className="logo-img">
                        <img className="img-color" src="https://www.coinapi.io/images/php-color.png" />
                        <img className="img-grey" src="https://www.coinapi.io/images/php-grey.png" />
                      </div>
                      <p>php</p>
                    </div>
                  </div>
                ...
                <div className="item">
                  <div className="logo">
                    <div className="logo-box">
                      <div className="logo-img">
                        <img className="img-color" src="https://www.coinapi.io/images/haskell-color.png" />
                        <img className="img-grey" src="https://www.coinapi.io/images/haskell-grey.png" />
                      </div>
                      <p>haskell</p>
                    </div>
                  </div>
                ...
                <div className="item">
                  <div className="logo">
                    <div className="logo-box">
                      <div className="logo-img">
                        <img className="img-color" src="https://www.coinapi.io/images/tensorflow-color.png" />
                        <img className="img-grey" src="https://www.coinapi.io/images/tensorflow-grey.png" />
                      </div>
                      <p>tensorflow</p>
                    </div>
                  </div>
                ...
                <div className="item">
                  <div className="logo">
                    <div className="logo-box">
                      <div className="logo-img">
                        <img className="img-color" src="https://www.coinapi.io/images/ruby-color.png" />
                        <img className="img-grey" src="https://www.coinapi.io/images/ruby-grey.png" />
                      </div>
                      <p>ruby</p>
                    </div>
                  </div>
              ...
              <a className="left carousel-control" href="#myCarousel" data-slide="prev"><img src="https://www.coinapi.io/images/arrow-left.png" /></a>
              <a className="right carousel-control" href="#myCarousel" data-slide="next"><img src="https://www.coinapi.io/images/arrow-right.png" /></a>
            </div>
          </div>
          ...
          <div className="row">
            ...
            <div className="col-md-4">
              <div className="cases-box fadeInLeft animate">
                <img className="space-bottom-3x" src="https://www.coinapi.io/images/x2/systematic-trading.png" alt="systematic trading" />
              ...
              <div className="cases-box fadeInLeft animate">
                <img src="https://www.coinapi.io/images/x2/portfolio.png" alt="portfolio valuation" />
            ...
            <div className="col-md-4">
              <div className="cases-box fadeInDown animate">
                <img className="space-bottom-3x" src="https://www.coinapi.io/images/x2/third-party.png" alt="third party integrations" />
              ...
              <div className="cases-box fadeInUp animate">
                <img className="space-bottom-3x" src="https://www.coinapi.io/images/x2/big-data.png" alt="big data science" />
            ...
            <div className="col-md-4">
              <div className="cases-box fadeInRight animate">
                <img className="space-bottom-3x" src="https://www.coinapi.io/images/x2/exchange-rates.png" alt="exchange rates" />
              ...
              <div className="cases-box fadeInRight animate">
                <img className="space-bottom-3x" src="https://www.coinapi.io/images/x2/marekt-making.png" alt="market making" />
                <h6>market making</h6>
            ...
            <div className="row">
              ...
              <div className="col-sm-2">
                ...
                <ul className="list-group collapse" id="developers" aria-expanded="false">
                  ...
                  <li className="list-group-item"><a href="https://docs.coinapi.io/" target="_blank">API Documentation</a></li>
                  <li className="list-group-item"><a href="http://status.coinapi.io/" target="_blank">Status Page</a></li>
                </ul>
              </div>

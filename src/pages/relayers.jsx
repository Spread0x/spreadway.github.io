...
const IndexPage = () => (
  <Layout headerClassName="darkgray">
   <div>
      <section id="site-main" className="site-main-darkgray">
          ...
          <div className="row">
            ...
            <div className="col-mdd-12">
               <div className="cases-box fadeInLeft animate">
                <img src="/images/step1relayers.svg" className="spread-main" alt="exchanges" />            
                <div className="case-desc">
                  <h4>Set task and specifications</h4>
             ...
             <div className="cases-box fadeInLeft animate">
              <img src="/images/step2relayers.svg" className="spread-main" alt="exchanges" />            
              <div className="case-desc">
                <h4>We will offer multiple templates and services to do your task</h4>
                <h6 className="cases-text2">Use our history intraday market data for backtesting your models, and our real-time market data stream for live trading and proactive portfolio risk management.</h6>
              </div>
            </div>
             <div className="cases-box fadeInLeft animate">
              <img src="/images/step3relayers.svg" className="spread-main" alt="exchanges" />            
              <div className="case-desc">
                <h4>Pay an extra small fee for the result</h4>
                <h6 className="cases-text2">Use our history intraday market data for backtesting your models, and our real-time market data stream for live trading and proactive portfolio risk management.</h6>
              </div>
            </div>
            </div>
